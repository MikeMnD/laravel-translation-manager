...
<div style="width: 80%; margin: auto;">
    ...
    <div class="alert alert-warning" role="alert">
        <b>Warning</b>, translations are not visible until they are exported back to the app/lang file, using 'php artisan translation:export' command or publish button
        <br>
        <b>WARNING!</b> DO NOT DELETE/CHANGE/TRANSLATE ANY words, beginning with ": "e.g. :attribute / :points
    </div>
    ...
    <?php endif; ?>
    <a href="<?= action('HomeController@index') ?>" class="btn btn-default">Back to website</a>
    <?php if(isset($group) && isAdmin()) : ?>
    ...
    <table class="table">
        <thead>
        <tr>
            <?php if(setting('manage.translation.showKeyColumn')) { ?>
            <th>Key</th>
            <?php } ?>
